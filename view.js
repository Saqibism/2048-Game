...
export const update = function(game){
    ...
    document.getElementById("score").innerHTML = "Your score: " + game.getGameState()['score']

    if(game.getGameState()['won']==true){
        document.getElementById("result").innerHTML = "You Won! Score: " + game.getGameState()['score'] + ". Press Reset Game or continue playing";
    }
    if(game.getGameState()['over']==true){
        document.getElementById("result").innerHTML = "You Lost! Score: " + game.getGameState()['score'] + ". Press Reset Game";
